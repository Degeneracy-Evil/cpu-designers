...
// ============================================================
// tb_isa_d_ext.sv — ISA D-extension (double-precision float) testbench
// ============================================================
//
// Tests: FADD.D/FSUB.D/FMUL.D/FDIV.D/FSQRT.D/FMIN.D/FMAX.D/
//        FSGNJ.D/FSGNJN.D/FSGNJX.D/FEQ.D/FLT.D/FLE.D/FCLASS.D/
//        FLD/FSD/FCVT.*.D/FCVT.D.*.*/FMV.X.D/FMV.D.X
// Subtests: 51
//
...
module tb_isa_d_ext;
    ...
    // ── 参数 ──
    localparam integer EXPECTED_TOTAL = 51;
    ...
    initial begin
        ...
        $display("");
        $display("========================================");
        $display("ISA D_EXT test summary");
