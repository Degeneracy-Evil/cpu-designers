`timescale 1ns / 1ps
module tb_regression_reg_dcache_wb_error;
    ...
    initial begin
        ...
        $display(""); $display("--- Regression dcache_wb_error Results ---");
        ...
        $display(""); $display("========================================");
        $display("Regression dcache_wb_error summary"); $display("pass=%0d fail=%0d", pass_count, fail_count);
