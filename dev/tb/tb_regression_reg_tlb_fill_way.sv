...
module tb_regression_reg_tlb_fill_way;
    ...
    wire [31:0] rf_data;
    wire [31:0] if_pc, if_inst, id_pc, id_inst, exe_pc, exe_inst, mem_pc, mem_inst, wb_pc, wb_inst, display_state;
    wire [31:0] cpu_HADDR, cpu_HWDATA, cpu_HRDATA;
    wire [1:0]  cpu_HTRANS;
    wire        cpu_HWRITE, cpu_HREADY, cpu_HRESP, cpu_HMASTLOCK;
    ...
    initial begin
        ...
        $display(""); $display("--- Regression tlb_fill_way Results ---");
        ...
        $display(""); $display("========================================");
        $display("Regression tlb_fill_way summary"); $display("pass=%0d fail=%0d", pass_count, fail_count);
