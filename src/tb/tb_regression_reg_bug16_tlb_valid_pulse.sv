...
module tb_regression_reg_bug16_tlb_valid_pulse;
    ...
    initial begin
        ...
        $display(""); $display("--- Regression bug16_tlb_valid_pulse Results ---");
        ...
        $display(""); $display("========================================");
        $display("Regression bug16_tlb_valid_pulse summary"); $display("pass=%0d fail=%0d", pass_count, fail_count);
