...
module tb_memory_contract;
    ...
    initial begin
        ...
        if(!fail_count)$display("ALL TESTS PASSED");else $fatal(1, "TEST FAILED");
        $finish;
    end

    initial begin repeat(1800)@(posedge clk);$fatal(1, "TEST FAILED: timeout");end
endmodule
