...
// ============================================================
// tb_privilege_priv_exceptions.sv — U/S/M privilege exception testbench
// ============================================================

module tb_privilege_priv_exceptions;
    ...
    initial begin
        ...
        $display("");
        $display("--- Privilege PRIV_EXCEPTIONS Results ---");
        ...
        $display("");
        $display("========================================");
        $display("Privilege PRIV_EXCEPTIONS summary");
