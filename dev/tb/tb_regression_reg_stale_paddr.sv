`timescale 1ns / 1ps
module tb_regression_reg_stale_paddr;
    ...
    initial begin
        ...
        $display(""); $display("--- Regression stale_paddr Results ---");
        ...
        $display(""); $display("========================================");
        $display("Regression stale_paddr summary"); $display("pass=%0d fail=%0d", pass_count, fail_count);
