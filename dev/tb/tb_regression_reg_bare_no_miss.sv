`timescale 1ns / 1ps
module tb_regression_reg_bare_no_miss;
    ...
    initial begin
        ...
        $display(""); $display("--- Regression bare_no_miss Results ---");
        ...
        $display(""); $display("========================================");
        $display("Regression bare_no_miss summary"); $display("pass=%0d fail=%0d", pass_count, fail_count);
