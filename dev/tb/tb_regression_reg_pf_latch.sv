`timescale 1ns / 1ps
module tb_regression_reg_pf_latch;
    ...
    initial begin
        ...
        $display(""); $display("--- Regression pf_latch Results ---");
        ...
        $display(""); $display("========================================");
        $display("Regression pf_latch summary"); $display("pass=%0d fail=%0d", pass_count, fail_count);
