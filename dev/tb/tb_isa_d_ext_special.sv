...
// ============================================================
// tb_isa_d_ext_special.sv — ISA D-extension exception/rounding testbench
// ============================================================
//
// Tests: NaN/Inf/zero/subnormal handling, rounding modes (RNE/RTZ/RDN/RUP/RMM/DYN),
//        fflags (NV/DZ/OF/UF/NX), fcsr, saturation
// Subtests: 28
//
// D tests need more cycles due to 64-bit load/store (2 transactions)
// and multi-cycle arithmetic (FDIV.D=55 iter, FSQRT.D=56 iter).
//
// ============================================================

module tb_isa_d_ext_special;

    // ── 参数 ──
    localparam integer EXPECTED_TOTAL = 28;
    ...
    initial begin
        ...
        $display("");
        $display("========================================");
        $display("ISA D_EXT_SPECIAL test summary");
