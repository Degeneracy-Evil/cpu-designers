#!/bin/bash
# =========================================================================
# MMU Unit Test Run Script
# Compiles and simulates tb_mmu_unit using Vivado xsim command-line flow
# =========================================================================
set -e
...
# Output directory
WORK_DIR=xsim_mmu_work
rm -rf $WORK_DIR
mkdir -p $WORK_DIR

echo "========================================"
echo "  MMU Unit Test Simulation"
echo "========================================"
