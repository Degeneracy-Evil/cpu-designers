...
详细信息  Why is the context keyword required to access element properties?  Normally, when we access a variable, we know exactly what its value is going to be:
