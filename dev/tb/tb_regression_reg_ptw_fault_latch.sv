...
module tb_regression_reg_ptw_fault_latch;
    ...
    initial begin
        ...
        $display(""); $display("--- Regression ptw_fault_latch Results ---");
        ...
        $display(""); $display("========================================");
        $display("Regression ptw_fault_latch summary"); $display("pass=%0d fail=%0d", pass_count, fail_count);
