...
// ============================================================
// tb_isa_f_f0_writable.sv — f0 (ft0) writable register testbench
// ============================================================
//
// Verifies that f0 is a normal writable FP register (not hardwired 0).
// Subtests: 5
//
// ============================================================

module tb_isa_f_f0_writable;

    // ── 参数 ──
    localparam integer EXPECTED_TOTAL = 5;
    ...
    initial begin
        ...
        $display("");
        $display("========================================");
        $display("ISA F_F0_WRITABLE test summary");
