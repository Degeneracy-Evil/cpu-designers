// =========================================================================
// defs.svh — fixed Cache & memory geometry constants
//
// These values describe the fixed RTL and block-memory layout. Keep them in
// sync with the Cache implementation and the fixed IP geometry in tools/vivado.
// =========================================================================
