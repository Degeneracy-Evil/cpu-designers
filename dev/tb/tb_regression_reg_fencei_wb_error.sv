`timescale 1ns / 1ps
module tb_regression_reg_fencei_wb_error;
    ...
    initial begin
        ...
        u_soc.sim_ram.u_axi_ram.BRAM[(32'h8000_3000 & 32'hFFFFF) >> 2] = 32'h0BAD_F00D;
    ...
    always @(posedge clk) begin
        if (u_soc.cpu.trap_enter_valid) begin
            $display("[fencei_wb_error] trap_enter pc=0x%08h mcause=0x%08h mtval=0x%08h",
    ...
    initial begin
        ...
        $display(""); $display("--- Regression fencei_wb_error Results ---");
        ...
        $display(""); $display("========================================");
        $display("Regression fencei_wb_error summary"); $display("pass=%0d fail=%0d", pass_count, fail_count);
