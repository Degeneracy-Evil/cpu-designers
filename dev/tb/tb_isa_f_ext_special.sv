...
// ============================================================
// tb_isa_f_ext_special.sv — ISA F-extension exception/rounding testbench
// ============================================================
//
// Tests: fflags (NV/DZ/OF/UF/NX), rounding modes (RNE/RTZ/RDN/RUP/RMM/DYN)
// Subtests: 24
//
// ============================================================

module tb_isa_f_ext_special;

    // ── 参数 ──
    localparam integer EXPECTED_TOTAL = 24;
    ...
    initial begin
        ...
        $display("");
        $display("========================================");
        $display("ISA F_EXT_SPECIAL test summary");
