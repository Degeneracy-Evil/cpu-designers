...
module tb_privilege_counter_access;
    ...
    initial begin
        ...
        $display("");
        $display("--- Privilege counter access Results ---");
        read_reg(5'd28, _val);
        ...
        $display("Privilege counter access summary: pass=%0d fail=%0d", pass_count, fail_count);
        if (fail_count == 0)
