...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "GPIO_NUM" -parent ${Page_0}
...
proc update_PARAM_VALUE.GPIO_NUM { PARAM_VALUE.GPIO_NUM } {
	# Procedure called to update GPIO_NUM when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.GPIO_NUM { PARAM_VALUE.GPIO_NUM } {
	# Procedure called to validate GPIO_NUM
	return true
}
...
proc update_MODELPARAM_VALUE.GPIO_NUM { MODELPARAM_VALUE.GPIO_NUM PARAM_VALUE.GPIO_NUM } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.GPIO_NUM}] ${MODELPARAM_VALUE.GPIO_NUM}
}
