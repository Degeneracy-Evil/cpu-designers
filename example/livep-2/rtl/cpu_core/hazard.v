...
module hazard(
    ...
    always@(*)begin
	if(rst)
		o_holdflag_first_1 <=1'b0;
		else if(ex_load_type_1 && if_read_2[1] && if_addrr1_5==ex_addrrd_5 && ex_addrrd_5)
			o_holdflag_first_1 <= 1'b1;
		else if(ex_load_type_1 && if_read_2[0] && if_addrr2_5==ex_addrrd_5 && ex_addrrd_5)
			o_holdflag_first_1 <= 1'b1;
		else
			o_holdflag_first_1 <=1'b0;
    end
