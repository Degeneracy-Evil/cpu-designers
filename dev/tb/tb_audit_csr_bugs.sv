...
module tb_audit_csr_bugs;

    localparam integer EXPECTED_TOTAL = 7;
    ...
    initial begin
        ...
        $display(""); $display("--- Audit csr_bugs Results ---");
        ...
        // Print individual test results from memory at 0x80007000+16+4*i
        ...
        $display(""); $display("========================================");
        $display("Audit csr_bugs summary"); $display("pass=%0d fail=%0d", pass_count, fail_count);
